          ...
          <div class="right-columns">
            ...
            <div class="footer-column">
              ...
              <div class="column-links">
                ...
                <a routerLink="/sobre-eduardo" class="footer-link">Sobre Eduardo</a>
                <a routerLink="/recursos" class="footer-link">Shop</a>
                <a routerLink="/club-inversion" class="footer-link">Club de Inversión</a>
