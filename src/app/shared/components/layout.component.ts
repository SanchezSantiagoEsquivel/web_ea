...
@Component({
  selector: 'app-layout',
  standalone: true,
  imports: [CommonModule, RouterOutlet, RouterLink, ContactModalComponent],
  template: `
    <div class="layout">
      <!-- Header -->
      <header class="header">
        <div class="container">
          <nav class="nav flex--between">
            ...
            <div class="nav__menu" [class.nav__menu--open]="isMenuOpen">
              <a routerLink="/" class="nav__link" routerLinkActive="nav__link--active" [routerLinkActiveOptions]="{exact: true}">Inicio</a>
              <a routerLink="/sobre-eduardo" class="nav__link" routerLinkActive="nav__link--active">Sobre Eduardo</a>
              <a routerLink="/club-inversion" class="nav__link" routerLinkActive="nav__link--active">Club de Inversión</a>
              <a routerLink="/recursos" class="nav__link" routerLinkActive="nav__link--active">Recursos</a>
              <button class="btn btn--primary" (click)="openContactModal()">Contacto</button>
            </div>
          ...
          <div class="grid grid--12">
            ...
            <div class="col--span-2 col--tablet-span-3 col--mobile-span-6">
              ...
              <ul class="footer__links">
                ...
                <li><a routerLink="/sobre-eduardo">Sobre Eduardo</a></li>
                <li><a routerLink="/club-inversion">Club de Inversión</a></li>
