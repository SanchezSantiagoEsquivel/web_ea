  ...
  <defs>
    <clipPath id="clip0_2865_1934">
      <rect width="80" height="52" />
          ...
          <!-- Main Content Frame -->
          <div class="main-content-frame" [class.no-cta]="!showCTA()">
            <!-- Text Content -->
...
export class HeroComponent {
  ...
  subtitle = input<string>('ESTRATEGIA Y PROPÓSITO PARA QUIENES PIENSAN EN GRANDE');
  title = input<string>('Haz de tu <span class="highlight">vida</span> tu<br>mejor <span class="highlight">inversión</span>');
